...
function enableEdit(e) {
    // Go up to parent element - link
    if (e.target.parentElement.classList.contains('edit')) {
        // Event delegation to get id, body, title
        var id = e.target.parentElement.dataset.id;
        var title = e.target.parentElement.previousElementSibling.previousElementSibling.textContent;
        var body = e.target.parentElement.previousSibling.previousSibling.textContent;
